    ...
    <>
      <div className="Hero pattern flex md:flex-row flex-col sm:mt-[52px] mt-[40px] ">
        <div className="container lg:max-w-7xl p-4  mx-auto md:mb-5 flex flex-col xl:gap-2 xl:mt-6 xl:ml-10 xl:-mr-14 xl:pr-0 ">
          ...
          <div className='md:mt-4 mt-10 flex md:flex-row flex-col md:gap-0  rounded-full sm:justify-between md:ml-7 xl:justify-start 2xl:pt-4 justify-center gap-10'>
            ...
            <span className=' text-xs mr-1 font-medium text-accent-100 md:p-0 p-3 2xl:text-lg'>Dr. B. R. Ambedkar National Institute of Technology,
Jalandhar
</span>
            </div>
